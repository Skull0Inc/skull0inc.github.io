...
description: "A code sample for importing icomoon icons from .zip file"
categories: [Rails,assets]
tags: [icomoon,rails,custom,import]
redirect_from:
  - /2017/05/27/
---
```
# Any custom Ruby code can be implemented in the lib/tasks folder where
# the task can be given the name: <name>.rake and executed through rails <name>

EXAMPLE
#
# Usage: rails icons:update["icomoon.zip"]
# Run above command to run below to import 
#
require 'rake'
